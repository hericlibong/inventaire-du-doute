	...
	<div class="footer-interieur">
		<div class="footer-identite">
			...
			<div class="footer-contacts" aria-label="Coordonnées et liens du projet">
				...
				<!-- LinkedIn en SVG intégré, et non importé : ni Simple Icons ni Lucide ne
				     fournissent ce logo dans les versions installées, et il ne vaut pas
				     d'ajouter une dépendance pour un seul glyphe. Le tracé est celui du
				     logo officiel, sur la même grille de 24 que SiGithub, en `currentColor`
				     — les deux icônes suivent donc la couleur du lien, au repos comme au
				     survol. Le SVG est masqué aux lecteurs d'écran : le nom accessible
				     vient de l'`aria-label` du lien, une seule fois. -->
				<a
					class="lien-icone"
					href="https://www.linkedin.com/in/hericlibong/"
					aria-label="Profil LinkedIn de Héric Libong"
					title="Profil LinkedIn de Héric Libong"
				>
					<svg
